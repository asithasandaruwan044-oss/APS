    ...
    <div class="admin-card">
        ...
        <div style="margin-top: 40px;">
            ...
            <table>
                ...
                <tr>
                    <td><%= u[0] %></td>
                    <td style="font-family: monospace; color: #f1c40f;"><%= u[1] %></td>
                    <td><span style="background: rgba(255,255,255,0.1); padding: 3px 10px; border-radius: 10px; font-size: 11px;"><%= u[2] %></span></td>
                    <td>
                        <% if (!u[0].equals(userName)) { %>
                        <a href="/deleteUser?username=<%= u[0] %>" style="color: #ff4757; text-decoration: none; font-weight: bold;" onclick="return confirm('Delete this user?')">❌ Remove</a>
                        <% } else { %>
